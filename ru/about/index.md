...
seo_title: О Bakasana — Напарник для регулярной йога-практики
description: Узнайте, что такое Bakasana, зачем появилось приложение, как работают четыре программы и какую роль играет Алёна Ткачева в подходе к регулярной практике.
social_title: О Bakasana
social_description: Ваш напарник для регулярной йога-практики, отслеживания прогресса и приватного Practice Timeline — с участием тренера Алёны Ткачевой.
